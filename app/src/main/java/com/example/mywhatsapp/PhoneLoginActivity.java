...
//                mAuth.createUserWithPhonecre(phoneAuthCredential)
...
//            }
            ...
            { Log.w(TAG, "onVerificationFailed", e);
                loadingBar.dismiss();
                Toast.makeText(PhoneLoginActivity.this, "Invalid Phone Number, Please enter correct 10 digit phone number ", Toast.LENGTH_SHORT).show();
